...
# NOTE: Assumes this is run within the ./training folder
...
# Create classifier
# Found Penalty parameter C=2.25 returned the highest accuracy for my training data
# Docs: http://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html#sklearn.svm.SVC
clf = svm.SVC(kernel='linear', C=2.25)
# Set up 5-fold cross-validation
kf = cross_validation.KFold(len(X_train), n_folds=5, shuffle=True,
                            random_state=1)

# Perform cross-validation
scores = cross_validation.cross_val_score(cv=kf, estimator=clf, X=X_train,
...
# Helpful Link: https://en.wikipedia.org/wiki/Confusion_matrix
plt.figure()
